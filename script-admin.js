// **NOTE: يجب استبدال هذه القيم بنفس إعدادات firebaseConfig الموجودة في ملف script.js**
...
function fetchOrders() {
    // جلب الطلبات التي حالتها ليست 'تم التوصيل' وتغيير الترتيب حسب وقت الإنشاء
    db.collection("orders")
        .where("status", "!=", "تم التوصيل") // لا تعرض الطلبات المكتملة
        .orderBy("status", "asc") // ترتيب الطلبات الجديدة أولاً
        ...
        .onSnapshot((snapshot) => {
            ...
            // إضافة مستمعي الأحداث للأزرار بعد عرض البطاقات
